...
/code [map|symbols]
/symbols [query]
/plugins [catalog [list|add-local|add-git|remove]|list|commands|scaffold|validate|inspect|register|install|enable|disable]
/plugin [list|status]
