...
/code [map|symbols]
/symbols [query]
/plugins [catalog [list|inspect|updates|add-local|add-git|remove]|list|commands|scaffold|validate|inspect|register|install|enable|disable]
/plugin [list|status]
...
/mcp [catalog|presets [inspect]|add-preset|list|inspect|tools|enable|disable|add-profile|remove-profile|add-tool|remove-tool|allow-tool|revoke-tool|allow-model-tool|revoke-model-tool|discover|remote-tools|import-remote-tools|call|model]
/models
/clear
/new
/quit
