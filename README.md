...
/code [map|symbols]
/symbols [query]
/plugins [catalog [list|add-local|remove]|list|commands|scaffold|validate|inspect|register|install|enable|disable]
/plugin [list|status]
