...
const RUNNABLE_DIAGNOSTIC_PROFILE_COMPLETIONS = ["typescript", "pyright", "eslint", "ruff", "mypy", "gopls", "clangd"] as const;
...
function handleTreeSitterCommandText(
  ...
  context: SlashCommandContext,
  usage: string,
  options: { defaultMode?: "parse" | "outline" | "imports" | "refs" | "calls" | "repo-files" | "repo-outline" | "repo-symbols" | "repo-refs" | "repo-calls" | "repo-imports" | "repo-deps" } = {},
): void {
