...
function helpText(): string {
  return [
    ...
    "  code          Render local code maps, symbol indexes, references, imports, calls, ast-grep searches, or tree-sitter parses/outlines/calls",
...
function runCodeTreeSitterCommand(
  args: string[],
  io: CliIo,
  options: { defaultMode?: "parse" | "outline" | "calls"; usage?: string } = {},
): number {
