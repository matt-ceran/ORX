...
function helpText(): string {
  return [
    ...
    "  code          Render local code maps, symbol indexes, references, imports, calls, ast-grep searches, or tree-sitter parses/outlines/imports/refs/calls/repo-outline/repo-refs/repo-calls/repo-imports/repo-deps",
...
function runCodeTreeSitterCommand(
  args: string[],
  io: CliIo,
  options: { defaultMode?: "parse" | "outline" | "imports" | "refs" | "calls" | "repo-outline" | "repo-refs" | "repo-calls" | "repo-imports" | "repo-deps"; usage?: string } = {},
): number {
