...
function helpText(): string {
  return [
    ...
    "  code          Render local code maps, symbol indexes, references, imports, calls, ast-grep searches, or tree-sitter parses/outlines/imports/refs/calls/repo-refs",
...
function runCodeTreeSitterCommand(
  args: string[],
  io: CliIo,
  options: { defaultMode?: "parse" | "outline" | "imports" | "refs" | "calls" | "repo-refs"; usage?: string } = {},
): number {
