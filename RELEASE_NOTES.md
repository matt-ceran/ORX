...
- LSP/SCIP and deeper semantic tree-sitter-backed reference/call intelligence beyond the current outline, single-file import/ref/call extraction, bounded repo AST identifier refs, and dependency-free indexes.
