...
- Additional scanner/diagnostics profiles beyond the current Semgrep, Trivy-secret, and TypeScript/Pyright/ESLint/Ruff/Mypy/gopls/clangd set only after deterministic no-network/no-auth command shapes are proven.
