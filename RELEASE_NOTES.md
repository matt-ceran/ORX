...
- LSP/SCIP and deeper tree-sitter-backed reference/import/cross-file call intelligence beyond the current outline, single-file call extraction, and dependency-free indexes.
