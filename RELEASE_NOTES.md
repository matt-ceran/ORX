...
- Additional provider read-only profiles and any write-capable GitHub/GitLab profiles only as explicit opt-ins with the same operator boundaries as existing MCP/plugin surfaces.
