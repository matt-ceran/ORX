...
- LSP/SCIP and deeper tree-sitter-backed reference/cross-file call intelligence beyond the current outline, single-file import/call extraction, and dependency-free indexes.
