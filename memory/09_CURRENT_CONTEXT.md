...
- Next likely task is a dedicated TTY visual QA harness or another bounded UI polish slice such as composer/input ergonomics; keep using bounded implementor/verifier loops and commit/push each verified step before starting the next one.
