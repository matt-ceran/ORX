...
- Next likely task is another small no-network structured-output/onboarding-polish slice or a dedicated TTY visual QA harness; keep using bounded implementor/verifier loops and commit/push each verified step before starting the next one.
