...
- Next likely work after this slice is another optional completion slice such as tree-sitter-backed references/cross-file call intelligence, LSP/SCIP diagnostics/references, config-only/non-JSON reporter integration, or wrapper-safe report integration.
