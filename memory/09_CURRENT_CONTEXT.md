...
- Next likely task is another bounded TTY UI polish slice or a small no-network structured-output/onboarding-polish slice; keep using bounded implementor/verifier loops and commit/push each verified step before starting the next one.
