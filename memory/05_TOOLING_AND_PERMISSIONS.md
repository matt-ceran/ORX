...
- explicit operator commands `orx diagnostics list [--json]`, `orx diagnostics inspect <profile> [--json]`, `orx diagnostics run <typescript|pyright|gopls|clangd> [--project <local-project-path>] [--json]`, `orx diag ...`, `/diagnostics ...`, and `/diag ...`
