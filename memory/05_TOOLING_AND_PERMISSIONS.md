...
- Delegation readiness output must continue to show execution disabled, no network calls, no subprocesses, no model-visible `delegate_task`, and blockers for the OpenRouter adapter plus live enforcement before adapters are implemented.
