...
- diagnostics profile catalog for TypeScript, TypeScript Language Server, Pyright, ESLint, rust-analyzer, gopls, clangd, and SCIP TypeScript
- explicit operator commands `orx diagnostics list [--json]`, `orx diagnostics inspect <profile> [--json]`, `orx diagnostics run <typescript|pyright|eslint|gopls|clangd> [--project <local-project-path>] [--json]`, `orx diag ...`, `/diagnostics ...`, and `/diag ...`
