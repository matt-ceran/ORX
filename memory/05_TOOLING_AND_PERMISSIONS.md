...
- explicit operator commands `orx diagnostics list`, `orx diagnostics inspect <profile>`, `orx diagnostics run <typescript|pyright|gopls|clangd> [--project <local-project-path>] [--json]`, `orx diag run ...`, `/diagnostics ...`, and `/diag ...`
