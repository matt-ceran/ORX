...
- tree-sitter-backed repo maps, syntax-aware references/imports, and cross-file call/dependency graphs beyond the current dependency-free overview/reference/import/call indexes and optional single-file tree-sitter call extraction.
