...
- tree-sitter-backed repo maps, semantic references, and cross-file call/dependency graphs beyond the current dependency-free overview/reference/import/call indexes and optional single-file tree-sitter import/ref/call plus bounded repo-ref extraction.
