...
- tree-sitter-backed repo maps, syntax-aware references, and cross-file call/dependency graphs beyond the current dependency-free overview/reference/import/call indexes and optional single-file tree-sitter import/call extraction.
