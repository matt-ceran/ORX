...
- Extend scanner profiles beyond the initial local Semgrep adapter only after deterministic no-network/no-auth command shapes are proven for Snyk, Socket, OSV-Scanner, CodeQL, or Trivy.
