...
- Extend scanner profiles beyond local Semgrep and Trivy-secret adapters only after deterministic no-network/no-auth command shapes are proven for Snyk, Socket, OSV-Scanner, CodeQL, or additional Trivy modes.
