...
The next plugin work should add remote source semantics, executable command design, and a separate runtime policy for plugin MCP endpoint discovery/tool execution without changing the current trust boundary.
