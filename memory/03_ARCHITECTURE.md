...
The next programming power-pack work should add richer code intelligence such as tree-sitter-backed call/reference slices, ast-grep previews, LSP/SCIP diagnostics, or framework-specific adapters beyond the initial package-script/Node test runner, model-visible `run_tests`, dependency-free code map, and exported-symbol index.
