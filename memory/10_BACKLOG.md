...
- Extend tree-sitter-backed code intelligence beyond the initial operator parse/outline/single-file-import/single-file-call previews into richer syntax-aware reference and cross-file call/dependency slices when grammar/runtime constraints are acceptable.
