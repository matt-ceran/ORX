...
- Extend structured test report ingestion beyond captured JSON stdout/stderr, direct Node JUnit fallback, and existing JSON reporter package-script temp files to default-reporter framework report files when safe.
