...
- Add documented provider preset packs/templates for local user MCP catalogs and/or plugins: `context7`, `github-readonly`, `browser`, `sentry-readonly`, `figma`, `db-dev`, `cloud-readonly`, and `cloud-write`.
