...
- Extend tree-sitter-backed code intelligence beyond the initial operator parse/outline/single-file-call previews into richer syntax-aware reference/import/cross-file call slices when grammar/runtime constraints are acceptable.
