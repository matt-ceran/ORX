...
- Extend the plugin system beyond the registry/CLI/cache/catalog/git-source/scaffold/validate substrate with richer marketplace/catalog UX, update checks, expanded authoring docs/templates, and optional stronger provenance/signing.
