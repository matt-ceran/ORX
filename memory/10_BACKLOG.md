...
- Extend structured test report ingestion beyond direct Node JUnit, JSON stdout/stderr, JSON reporter temp files, exact default framework runner temp files, and declared JSON output files to config-only outputs, non-JSON/custom reporters, or wrapper commands when safe.
