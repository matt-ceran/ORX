...
- Extend tree-sitter-backed code intelligence beyond the current operator parse/outline/single-file-import/single-file-ref/repo-ref/single-file-call/repo-call previews into richer semantic reference and dependency-resolution slices when grammar/runtime constraints are acceptable.
