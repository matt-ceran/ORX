...
- Add tree-sitter-backed code intelligence for richer syntax-aware call/reference/import slices beyond the dependency-free code map, exported-symbol index, reference index, import graph, lexical call graph, and optional ast-grep adapter.
