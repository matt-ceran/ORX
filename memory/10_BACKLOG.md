...
- Extend tree-sitter-backed code intelligence beyond the current operator parse/outline/single-file-import/single-file-ref/repo-ref/single-file-call previews into richer semantic reference and cross-file call/dependency slices when grammar/runtime constraints are acceptable.
