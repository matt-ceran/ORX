...
| P2 | Sentry, Linear, Atlassian, Figma, Notion | Workflow planning presets now exist for Sentry, Figma, Atlassian Rovo, Linear, and Notion; keep write-capable providers disabled/no-static-tools until remote metadata review and explicit grants. |
