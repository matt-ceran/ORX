...
- `renderTtyStatusProbe(width)` provides a small pure render probe for 80, 120, and narrow-width HUD checks. Pixel-level PTY/xterm/browser screenshot verification is still a future visual QA harness, not part of the current dependency set.
